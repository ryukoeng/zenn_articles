...
EC2・S3・VPC など AWS 関連の記事。

| 記事 | slug | topics | published | 概要 |
| ---- | ---- | ------ | --------- | ---- |
| [EC2の基礎概念備忘録](../articles/aws-ec2-basics.md) | aws-ec2-basics | aws, ec2 | 公開済み | EC2 の構成要素・AMI・インスタンスタイプ・ストレージ・料金モデルの基礎 |
| [s3作成備忘録](../articles/aws-s3-bucket-create.md) | aws-s3-bucket-create | aws | 公開済み | S3 バケット作成時の設定項目（ACL・公開ブロック・バージョニング・暗号化）と推奨構成 |
